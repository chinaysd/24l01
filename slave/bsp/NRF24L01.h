...
//NRF2401片选信号
#define CE_L GPIO_WriteLow(CE_PORT, CE_PIN)
#define CE_H GPIO_WriteHigh(CE_PORT, CE_PIN)

//SPI片选信号
#define CSN_L GPIO_WriteLow(CSN_PORT, CSN_PIN)
#define CSN_H GPIO_WriteHigh(CSN_PORT, CSN_PIN)
...
//SPI输出
#define MOSI_L GPIO_WriteLow(MOSI_PORT, MOSI_PIN)
#define MOSI_H GPIO_WriteHigh(MOSI_PORT, MOSI_PIN)

//SPI输入
#define READ_MISO GPIO_ReadInputPin(MISO_PORT, MISO_PIN)

//IRQ中断脚
#define IRQ_L GPIO_WriteLow(IRQ_PORT, IRQ_PIN)
#define IRQ_H GPIO_WriteHigh(IRQ_PORT, IRQ_PIN)

#define READ_IRQ GPIO_ReadInputPin(IRQ_PORT, IRQ_PIN)
